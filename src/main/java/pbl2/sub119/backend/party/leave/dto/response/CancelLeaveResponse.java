...
public record CancelLeaveResponse(
    ...
    public static CancelLeaveResponse forcedLeft(Long rematchedPartyId, Integer monthlyPaymentAmount) {
        return new CancelLeaveResponse(
                LeaveCancelResult.FORCED_LEFT,
                "입장 대기자가 있어 탈퇴가 확정되었습니다. 동일 상품 내 자동 재매칭을 시작합니다.",
                rematchedPartyId,
