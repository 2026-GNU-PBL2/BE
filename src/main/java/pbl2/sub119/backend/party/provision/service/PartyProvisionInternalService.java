...
@Transactional
public class PartyProvisionInternalService {
    ...
    public void openOperation(final Long partyId) {
        ...
        final PartyProvision existing = partyOperationMapper.findByPartyId(partyId);
        ...
        final PartyProvision operation = PartyProvision.builder()
                .partyId(partyId)
        ...
        for (PartyMember member : members) {
            final PartyProvisionMember operationMember = PartyProvisionMember.builder()
                    ...
                    .memberStatus(ProvisionMemberStatus.WAITING)
