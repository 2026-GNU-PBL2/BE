...
public enum ErrorCode {
    ...
    PAYMENT_CYCLE_NOT_FOUND(HttpStatus.NOT_FOUND, "PAYMENT008", "결제 사이클을 찾을 수 없습니다."),
    PAYMENT_CYCLE_RETRY_NOT_ALLOWED(HttpStatus.CONFLICT, "PAYMENT009", "FAILED 상태의 결제 사이클만 재시도할 수 있습니다."),
    PAYMENT_CYCLE_RETRY_DEADLINE_EXCEEDED(HttpStatus.CONFLICT, "PAYMENT010", "재시도 가능 기간(7일)이 초과되었습니다."),
